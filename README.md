...
<!-- TODO: evaluate usefulness of HELP.md - some links may be stale -->
For background resources see [`HELP.md`](HELP.md).
...
4. Post-deployment validation
    ...
    - Check [`greenboot`](https://github.com/fedora-iot/greenboot.git) and rollback
...
<!-- TODO: verify whether the Upstream CI section is still accurate -->
### Upstream CI
...
<!-- TODO: remove this section or replace with current dashboard links -->
[RHEL 8/9, CentOS Stream 8/9 report dashboard](https://github.com/virt-s1/rhel-edge/projects/1) *(link may be stale)*

[Fedora report dashboard](https://github.com/virt-s1/rhel-edge/projects/2) *(link may be stale)*

[Package greenboot, fido-device-onboard, rust-coreos-installer, rpm-ostree, ostree report](https://github.com/virt-s1/rhel-edge/projects/3) *(link may be stale)*

[Customer case test report](https://github.com/virt-s1/rhel-edge/projects/4) *(link may be stale)*
...
2. [`spellcheck`](https://github.com/codespell-project/codespell)
...
| [`ostree-iot-qcow2.sh`](ostree-iot-qcow2.sh) | `iot-qcow2` | IoT `qcow2` image test |
...
<!-- TODO: update aarch64 section with current usage -->
...
#### For aarch64
    ...
    <test os> can be one of "rhel-9-4", "centos-stream-9", "fedora-42"

<!-- TODO: check each arm-*.sh script for supported <test os> values -->

## Contact us

<!-- TODO: verify Google Chat link and consider adding other contact channels -->
RHEL for Edge discussion channel: [`Google Chat room`](https://mail.google.com/chat/u/0/#chat/space/AAAAlhJ-myk) *(link may be stale)*
